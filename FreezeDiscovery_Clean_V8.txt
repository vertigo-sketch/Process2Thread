<#
  ...
  - PS 5.1 / ISE safe
  - Adds Application log Event ID 1002 reporting (same process used for System 153 via Get-WinEvent)
  - Merges Application 1002 events into SystemEvents_48h.csv (same CSV file)
...
# ==========================================================
# A3 signals (UPDATED): add Application ID 1002 and merge into SystemEvents_48h.csv
...
function Get-EventSignals {
    ...
    # Application ID updated per request
    $appIds = 1002
    ...
    return [pscustomobject]@{
        ...
        # Updated count name for Application 1002
...
# Human summary (include Application1002Count)
$humanLines = @(
...
# Ticket summary (mention Application 1002 and that CSV includes it)
$ticketLines = @(
    ...
    "- EventSignals.json"
    "- SystemEvents_48h.csv   (includes System + Application(1002))"
